    ...
    <div className="h-screen overflow-hidden bg-slate-50 dark:bg-slate-950 flex text-slate-800 dark:text-slate-200 font-sans transition-colors duration-200">
      ...
      <aside className={`fixed inset-y-0 left-0 z-50 w-64 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 transform transition-transform duration-200 ease-in-out lg:translate-x-0 lg:static lg:flex lg:flex-col ${mobileMenuOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        <div className="h-16 flex items-center justify-between px-6 border-b border-slate-100 dark:border-slate-800">
          ...
          <button className="lg:hidden text-coffee-400 hover:text-slate-200" onClick={() => setMobileMenuOpen(false)}>
            <X size={20} />
          </button>
        </div>

        <div className="flex-1 overflow-y-auto py-6 px-4">
          <div className="text-xs font-bold text-slate-400 dark:text-coffee-500 mb-4 px-2 tracking-wider uppercase">
            {roleTitle} PORTAL
          </div>
                ...
                <Link
                  ...
                  className={`flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors ${
                    isActive 
                      ...
                      : 'text-coffee-600 dark:text-slate-400 hover:bg-coffee-200 dark:hover:bg-slate-800/50 hover:text-coffee-900 dark:hover:text-white'
                  }`}
                >
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="h-16 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between px-4 sm:px-6 z-10 transition-colors duration-200">
          <div className="flex items-center gap-4">
            <button 
              className="lg:hidden text-slate-500 dark:text-coffee-400 hover:text-slate-700 dark:hover:text-slate-200 p-1"
              onClick={() => setMobileMenuOpen(true)}
            >
              <Menu size={24} />
            </button>
            <div className="hidden sm:block">
              <div className="text-[10px] font-bold text-slate-400 dark:text-coffee-500 uppercase tracking-widest">{roleTitle} PORTAL</div>
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <button 
              ...
              className={`relative p-1.5 rounded-full transition-colors ${is2FAEnabled ? 'text-emerald-500 hover:bg-emerald-50 dark:hover:bg-emerald-900/20' : 'text-coffee-400 hover:text-coffee-600 hover:bg-slate-100 dark:hover:bg-slate-800'}`}
            >
            ...
            <button 
              ...
              className="relative text-coffee-400 hover:text-slate-600 dark:hover:text-slate-300 transition-colors p-1.5 rounded-full hover:bg-slate-100 dark:hover:bg-slate-800"
            >
              {isDarkMode ? <Sun size={18} /> : <Moon size={18} />}
            </button>
            
            <button className="relative text-coffee-400 hover:text-slate-600 dark:hover:text-slate-300 transition-colors p-1.5 rounded-full hover:bg-slate-100 dark:hover:bg-slate-800">
              <Bell size={18} />
            ...
            <Link 
              ...
              className="flex items-center gap-2 text-slate-500 dark:text-coffee-400 hover:text-slate-800 dark:hover:text-slate-200 transition-colors"
              title="View Profile"
            >
