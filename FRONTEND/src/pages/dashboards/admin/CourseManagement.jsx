        ...
        {loading ? (
          <div className="flex items-center justify-center p-16">
            <div className="flex flex-col items-center gap-3">
              ...
              <p className="text-xs text-[var(--lms-text-muted)] font-medium">Loading platform courses...</p>
            </div>
          </div>
        ) : courses.length === 0 ? (
          <div className="text-center py-20 lms-glass-card rounded-2xl border border-[var(--lms-border)]">
            ...
            <h3 className="text-lg font-bold text-[var(--lms-text-primary)] mb-1">No courses found</h3>
            <p className="text-xs text-[var(--lms-text-secondary)] max-w-md mx-auto">Instructors have not created any courses yet.</p>
          </div>
        ) : (
