      ...
      <div className="p-6 max-w-4xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-[var(--lms-text-secondary)] text-sm">Start building your next masterpiece.</p>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit} className="p-6 sm:p-8 space-y-8">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                {fetchingCats && <p className="text-xs text-blue-500 mt-2 flex items-center gap-1"><Loader size={12} className="animate-spin" /> Loading categories...</p>}
              </div>
